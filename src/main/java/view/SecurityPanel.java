...
public class SecurityPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        securityAlarmLabel = new javax.swing.JLabel();
        ...
        securityServiceFactory = new ConcreteSecurityFactory();
        securityService = securityServiceFactory.createService();
        user.setService(securityService);

        bill = Bill.getInstance();
        user.setBill(bill);

        securityService.sensorList = new ArrayList<>();
        sectionButtonList = new ArrayList<>();
        roomButtonList = new ArrayList<>();
        //end

        securityAlarmLabel.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        securityAlarmLabel.setText("Security System");
                ...
                systemPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(systemPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(systemPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addComponent(securityAlarmLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        systemPanelLayout.setVerticalGroup(
                systemPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(systemPanelLayout.createSequentialGroup()
                                .addGap(25, 25, 25)
                                .addComponent(securityAlarmLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(58, 58, 58)
                                ...
                                .addGap(30, 30, 30)
                                .addComponent(billingButton, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void startButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        for (int i = 0; i < sectionButtonList.size(); i++) {
            if(sectionButtonList.get(i).isSelected()) {
                Section section = securityService.getSectionId(i);
        ...
        for (int i = 0; i < roomButtonList.size(); i++) {
            if(roomButtonList.get(i).isSelected()) {
                Room room = securityService.getRoomId(i);
        ...
        for(int i =0; i < calNumOfActivatedRoom(); i++){
            Sensor sensor = (Sensor) DetectorFactory.getSensor("Security");
            user.setSensor(sensor);
            sensor.setVariable();
            sensor.setSensorStatus(true);
            sensor.setSensorID(i + 1);
            sensor.setLocation("Area");
            DetailInfoTextArea.append(sensor.displaySensorInfo());
        }
        double cost = user.getSensor().getSensorCost() * calNumOfActivatedRoom() + user.getBill().INSTALL_FEE;
        user.getBill().setNumberOfSensors(calNumOfActivatedRoom());
        user.getBill().setCost(cost);
    }

    private void TriggerSectionButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        securityAlarm = securityServiceFactory.createAlarm();
        if (sectionRadioButton1.isSelected()) {
            AlarmPanel alarmPanel = new AlarmPanel("securityAlarm.jpeg", user);
            alarmPanel.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
            alarmPanel.setVisible(true);
        } else {
            for (Room room : securityService.getRoomList1()) {
                if (room.isSelected) {
                    AlarmPanel alarmPanel = new AlarmPanel("securityAlarm.jpeg", user);
                    alarmPanel.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
                    alarmPanel.setVisible(true);
    ...
    private void TriggerSectionButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (sectionRadioButton2.isSelected()) {
            ...
            for (Room room : securityService.getRoomList2()) {
                if (room.isSelected) {
                    AlarmPanel alarmPanel = new AlarmPanel("securityAlarm.jpeg", user);
                    alarmPanel.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
                    alarmPanel.setVisible(true);
    ...
    private void TriggerSectionButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (sectionRadioButton3.isSelected()) {
            ...
            for (Room room : securityService.getRoomList3()) {
                if (room.isSelected) {
                    AlarmPanel alarmPanel = new AlarmPanel("securityAlarm.jpeg", user);
                    alarmPanel.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
                    alarmPanel.setVisible(true);
    ...
    private void TriggerSectionButton4ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (sectionRadioButton4.isSelected()) {
            ...
            for (Room room : securityService.getRoomList4()) {
                if (room.isSelected) {
                    AlarmPanel alarmPanel = new AlarmPanel("securityAlarm.jpeg", user);
                    alarmPanel.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
                    alarmPanel.setVisible(true);
    ...
    private void BillingButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        userFrame.setBounds(400, 300, 780,750 );
    ...
    private javax.swing.JLabel securityAlarmLabel;
    ...
    private User user;
    private Bill bill;
    private Alarm securityAlarm;
    private AbstractServiceFactory securityServiceFactory;
