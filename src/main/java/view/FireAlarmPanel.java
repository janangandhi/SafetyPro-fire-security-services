...
public class FireAlarmPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        fireAlarmServiceFactory = new ConcreteFireAlarmFactory();
        fireAlarmService = fireAlarmServiceFactory.createService();
        ...
        fireAlarmLabel.setText("Fire Alarm System");
    ...
    private void TriggerSectionButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        fireAlarm = fireAlarmServiceFactory.createAlarm();
    ...
    private User user;
    private Bill bill;
    private Alarm fireAlarm;
    private AbstractServiceFactory fireAlarmServiceFactory;
